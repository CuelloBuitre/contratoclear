...
const FEATURES = [
  ...
  },
  {
    ...
    titleKey: 'landing.features.items.6' as const,
  },
  {
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
          d="M3 6l9-3 9 3M3 6v14l9 3 9-3V6M12 3v18" />
      </svg>
    ),
    titleKey: 'landing.features.items.7' as const,
  },
]
        ...
        <div className="mx-auto max-w-[800px] px-4 sm:px-6">
          <div className="mb-10 text-center">
            ...
            <h2 className="heading-section text-[#0f0f1a]">
              {t('rentCalculator.landingTitle')}
            </h2>
            <p className="mt-3 text-base text-[#6b6860]">{t('rentCalculator.landingSubtitle')}</p>
          </div>
